				...
				<div class="entry-content">
					...
					<header class="entry-header">
						<div class="entry-meta item-meta">
							...
							<?php towy_posted_on( true, true ); ?>
							<?php esc_html_e( 'in', 'towy' ); ?> <span class="parent-post-link darklinks"><a href="<?php echo get_permalink( $post->post_parent ); ?>"><?php echo get_the_title( $post->post_parent ); ?></a></span>
						</div><!-- .entry-meta -->
					</header><!-- .entry-header -->
					<?php
					the_content();
					wp_link_pages( array(
						'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'towy' ) . '</span>',
						'after'       => '</div>',
						'link_before' => '<span>',
						'link_after'  => '</span>',
					) );
			...
			<nav id="image-navigation"
				...
				<div class="display_table">
					<div class="display_table_cell">
						<?php previous_image_link( false, '<div class="previous-image">' . esc_html__( 'Previous Image', 'towy' ) . '</div>' ); ?>
					</div>
					<div class="display_table_cell text-right">
						<?php next_image_link( false, '<div class="next-image">' . esc_html__( 'Next Image', 'towy' ) . '</div>' ); ?>
					</div>
				</div><!-- .nav-links -->
