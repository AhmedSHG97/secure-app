...
if ( class_exists( 'MWT_Widget_Popular' ) ) {
	return;
}

class MWT_Widget_Popular extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'Most commented Posts', 'mwt' ),
		);
		parent::__construct( false, esc_html__( 'Theme - Popular Posts', 'mwt' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$filepath = MWT_WIDGETS_PLUGIN_PATH . '/widgets/popular/views/widget.php';
