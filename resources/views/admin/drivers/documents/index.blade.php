                ...
                <tr>
                    ...
                    <td class="comment_td">
                     ...
                     <td>
                        ...
                        @else
                            <a href="#" class="open-image"  title="View Image 1">
                                <i class="imageresource fas fa fa-file-image-o" data-src="{{ $docImage[0] }}"></i>
                            </a>
                            @if(isset($docImage[1]))
                            <a href="#" class="open-image1"  title="View Image 2">
                                <i class="imageresource1 fas fa fa-file-image-o" data-src="{{ $docImage[1] }}"></i>
                            </a>
                            @endif
...
<div class="modal fade bd-example-modal-lg" id="imagemodal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: fit-content;">
        <div class="modal-content">
            <div class="modal-body">
                <img src="" class="imagepreview1" style="height: 80vh;">
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-danger btn-sm close-modal1 float-right">Close</button>
                <a href="" class="downloadImage1" download>
...
<div class="modal fade bd-example-modal-lg" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: fit-content;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-danger btn-sm close-modal float-right">Close</button>
...
<script>
    ...
    $(document).on('click','.open-image1',function(){
        let image = $(this).find('.imageresource1').attr('data-src');
        console.log(image);
        $('.imagepreview1').attr('src', image);
        $('.downloadImage1').attr('href',image);
    ...
    $(document).on('click','.close-modal1',function(){
        $('.imagepreview1').attr('src', "");
        $('.downloadImage1').attr('href',"");
