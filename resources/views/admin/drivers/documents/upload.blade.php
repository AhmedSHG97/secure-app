    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            {{csrf_field()}}
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="document">@lang('Document')</label><br>
                        <img id="blah" src="{{ isset($driverDoc->image[0]) ? $driverDoc->image[0] : '' }}" alt=""><br>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="document">@lang('Another document')</label><br>
                        <img id="blah1" src="{{ isset($driverDoc->image[1]) ? $driverDoc->image[1] : '' }}" alt=""><br>
                        <input type="file" id="document1" onchange="readURL(this)" name="document[]" style="display:none">
                        <button class="btn btn-primary btn-sm" type="button" onclick="$('#document1').click()" id="upload">Browse</button>
                        <button class="btn btn-danger btn-sm" type="button" id="remove_img1" style="display: none;">Remove</button><br>
                        <span class="text-danger">{{ $errors->first('document') }}</span>
                    </div>
                </div>
