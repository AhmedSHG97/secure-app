...
class CreateRequestController extends BaseController
{
    ...
    public function createRequest(CreateTripRequest $request)
    {
        ...
        // $user = User::where("email", "bennebosmarket2020@gmail.com")->first();
        // if ($user) {
        //     $driver = $user->driver;
        //     $updated_params = [
        //         'driver_id' => $driver->id,
        ...
        //     // $this->deleteMetaRecords($request_detail->id);
        ...
        if (!$nearest_drivers) {
            goto no_near_drivers_available;
        }
        $selected_drivers = [];
        $i = 0;
    ...
    public function deleteMetaRecords($request_id)
    {
...
//		dd($nearest_drivers, $driver_search_radius);
