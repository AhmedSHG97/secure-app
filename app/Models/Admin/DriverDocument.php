    ...
    public function getImageAttribute($value)
    {
        ...
        if(is_array($images)){
            foreach($images as $image){
                $images_array[] = Storage::disk(env('FILESYSTEM_DRIVER'))->url(file_path($this->uploadPath(), $image));
            }
        }else{
            $images_array[] = Storage::disk(env('FILESYSTEM_DRIVER'))->url(file_path($this->uploadPath(), $value));
        }
